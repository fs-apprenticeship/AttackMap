...
const SYSTEM_PROMPT = [
  ...
  "`steps` (an array of ordered, concrete actions; may use inline `code` for",
  "paths or values; empty array if not needed);",
  ...
  "`verification` (one command or check to confirm the fix; \"\" if none);",
