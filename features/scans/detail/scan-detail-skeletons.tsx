    ...
    >
      <div className="mx-auto w-full max-w-[1500px] px-4 py-5 lg:px-6">
        <div className="mb-5 flex items-center justify-between gap-3">
          <Skeleton className="h-8 w-24 rounded-md bg-card" />
          <Skeleton className="h-8 w-24 rounded-md bg-card" />
        </div>

        <div className="mb-5 rounded-md border bg-card p-4 shadow-sm">
        ...
        <div className="min-w-0 flex-1 space-y-6">
          <CardSkeleton className="overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-10 p-4 xl:grid-cols-[minmax(0,7fr)_minmax(300px,3fr)]">
              <div className="order-1 rounded-md border bg-muted/40 p-5 xl:col-start-2 xl:row-start-1">
              ...
              <div className="order-2 rounded-md border bg-muted/40 p-5 xl:col-start-2 xl:row-start-2">
              ...
              <div className="order-3 rounded-md border bg-muted/40 p-5 xl:col-start-1 xl:row-start-1">
                <div className="mb-5 flex items-center justify-between gap-3">
              ...
              <div className="order-4 overflow-hidden rounded-md border bg-muted/40 xl:col-start-1 xl:row-start-2">
